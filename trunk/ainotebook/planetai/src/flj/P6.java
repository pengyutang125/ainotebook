...
public abstract class P6<A, B, C, D, E, Z> {
  /**
   ...
   */
  public <X> P6<X, B, C, D, E, Z> map1(final F<A, X> f) {
    return new P6<X, B, C, D, E, Z>() {
      public X _1() {
   ...
   * @return A product with the given function applied.
   */
  public <X> P6<A, X, C, D, E, Z> map2(final F<B, X> f) {
    return new P6<A, X, C, D, E, Z>() {
      public A _1() {
        return P6.this._1();
      }
   ...
   * @return A product with the given function applied.
   */
  public <X> P6<A, B, X, D, E, Z> map3(final F<C, X> f) {
    return new P6<A, B, X, D, E, Z>() {
      public A _1() {
        return P6.this._1();
      }
   ...
   * @return A product with the given function applied.
   */
  public <X> P6<A, B, C, X, E, Z> map4(final F<D, X> f) {
    return new P6<A, B, C, X, E, Z>() {
      public A _1() {
        return P6.this._1();
      }
   ...
   * @return A product with the given function applied.
   */
  public <X> P6<A, B, C, D, X, Z> map5(final F<E, X> f) {
    return new P6<A, B, C, D, X, Z>() {
      public A _1() {
        return P6.this._1();
      }
   ...
   * @return A product with the given function applied.
   */
  public <X> P6<A, B, C, D, E, X> map6(final F<Z, X> f) {
