 ...
 * @version 2.20<br>
 *          <ul>
 *          <li>$LastChangedRevision: 196 $</li>
 *          <li>$LastChangedDate: 2009-06-28 16:02:26 +1000 (Sun, 28 Jun 2009) $</li>
 *          <li>Author: runar</li>
 *          </ul>
 */
public final class Tree<A> implements Iterable<A> {
  ...
  public Stream<A> flatten() {
    final F2<Tree<A>, P1<Stream<A>>, Stream<A>> squish = new F2<Tree<A>, P1<Stream<A>>, Stream<A>>() {
      public Stream<A> f(final Tree<A> t, final P1<Stream<A>> xs) {
        return Stream.cons(t.root(), t.subForest().map(Stream.<Tree<A>, Stream<A>>foldRight().f(Function.curry(this)).f(xs._1())));
      }
    };
  ...
  public Stream<Stream<A>> levels() {
    final F<Stream<Tree<A>>, Stream<Tree<A>>> flatSubForests =
        Stream.<Tree<A>, Tree<A>>bind_().f(Function.compose(P1.<Stream<Tree<A>>>__1(), Tree.<A>subForest_()));
    final F<Stream<Tree<A>>, Stream<A>> roots = Stream.<Tree<A>, A>map_().f(Tree.<A>root_());
    return Stream.iterateWhile(flatSubForests, Stream.<Tree<A>>isNotEmpty_(), Stream.single(this)).map(roots);
  }
  ...
  public Tree<Tree<A>> cojoin() {
    final F<Tree<A>, Tree<A>> id = Function.identity();
    return cobind(id);
  }
  ...
  public <B, C> Tree<C> zipWith(final Tree<B> bs, final F2<A, B, C> f) {
    return F2W.$$(f).zipTree().f(this, bs);
  }
