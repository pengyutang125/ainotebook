 ...
 *          </ul>
 */
public final class FClass<T> {
  private final java.lang.Class<T> c;

  private FClass(final java.lang.Class<T> c) {
    this.c = c;
  }
   ...
   */
  public List<FClass<? super T>> inheritance() {
    return List.unfold(
        ...
        }, c).map(new F<java.lang.Class<? super T>, FClass<? super T>>() {
      public FClass<? super T> f(final java.lang.Class<? super T> c) {
        return clas(c);
      }
    });
  }
   ...
   */
  public static <T> FClass<T> clas(final java.lang.Class<T> c) {
    return new FClass<T>(c);
  }
}
