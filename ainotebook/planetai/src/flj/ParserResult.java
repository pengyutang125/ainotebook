 ...
 *          </ul>
 */
public final class ParserResult<I, A> implements Iterable<A> {
  private final I i;
  private final A a;

  private ParserResult(final I i, final A a) {
    this.i = i;
    this.a = a;
  }
   ...
   */
  public <J> ParserResult<J, A> mapRest(final F<I, J> f) {
   ...
   */
  public <J> F<F<I, J>, ParserResult<J, A>> mapRest() {
    return new F<F<I, J>, ParserResult<J, A>>() {
      public ParserResult<J, A> f(final F<I, J> f) {
        return mapRest(f);
      }
    };
  }
   ...
   */
  public <B> ParserResult<I, B> mapValue(final F<A, B> f) {
   ...
   */
  public <B> F<F<A, B>, ParserResult<I, B>> mapValue() {
    return new F<F<A, B>, ParserResult<I, B>>() {
      public ParserResult<I, B> f(final F<A, B> f) {
        return mapValue(f);
      }
    };
  }
   ...
   */
  public <B, J> ParserResult<J, B> bimap(final F<I, J> f, final F<A, B> g) {
   ...
   */
  public <B, J> F<F<I, J>, F<F<A, B>, ParserResult<J, B>>> bimap() {
    return Function.curry(new F2<F<I, J>, F<A, B>, ParserResult<J, B>>() {
      public ParserResult<J, B> f(final F<I, J> f, final F<A, B> g) {
        return bimap(f, g);
      }
    });
  }
   ...
   */
  public static <A, I> ParserResult<I, A> result(final I i, final A a) {
    return new ParserResult<I, A>(i, a);
  }
   ...
   */
  public static <A, I> F<I, F<A, ParserResult<I, A>>> result() {
    return Function.curry(new F2<I, A, ParserResult<I, A>>() {
      public ParserResult<I, A> f(final I i, final A a) {
        return result(i, a);
      }
    });
  }
