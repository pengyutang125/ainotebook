...
public final class Array<A> implements Iterable<A> {
  ...
  public Option<A> toOption() {
    return a.length == 0 ? Option.<A>none() : Option.some((A) a[0]);
  }
  ...
  public <B> Array<B> sequence(final Array<B> bs) {
    final F<A, Array<B>> c = Function.constant(bs);
    return bind(c);
  }
  ...
  public static <A> Array<A> join(final Array<Array<A>> o) {
    final F<Array<A>, Array<A>> id = Function.identity();
    return o.bind(id);
  }
