 ...
 * @version 2.20<br>
 *          <ul>
 *          <li>$LastChangedRevision: 126 $</li>
 *          <li>$LastChangedDate: 2009-05-05 13:39:54 +1000 (Tue, 05 May 2009) $</li>
...
public final class Result {
  ...
  public static Result unfalsified(final List<Arg<?>> args) {
    return new Result(Option.some(args), R.Unfalsified, Option.<Throwable>none());
  }
  ...
  public static Result falsified(final List<Arg<?>> args) {
    return new Result(Option.some(args), R.Falsified, Option.<Throwable>none());
  }
  ...
  public static Result proven(final List<Arg<?>> args) {
    return new Result(Option.some(args), R.Proven, Option.<Throwable>none());
  }
