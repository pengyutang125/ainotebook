...
public abstract class P7<A, B, C, D, E, Z, G> {
  /**
   ...
   */
  public <X> P7<X, B, C, D, E, Z, G> map1(final F<A, X> f) {
    return new P7<X, B, C, D, E, Z, G>() {
      public X _1() {
   ...
   * @return A product with the given function applied.
   */
  public <X> P7<A, X, C, D, E, Z, G> map2(final F<B, X> f) {
    return new P7<A, X, C, D, E, Z, G>() {
      public A _1() {
        return P7.this._1();
      }
   ...
   * @return A product with the given function applied.
   */
  public <X> P7<A, B, X, D, E, Z, G> map3(final F<C, X> f) {
    return new P7<A, B, X, D, E, Z, G>() {
      public A _1() {
        return P7.this._1();
      }
   ...
   * @return A product with the given function applied.
   */
  public <X> P7<A, B, C, X, E, Z, G> map4(final F<D, X> f) {
    return new P7<A, B, C, X, E, Z, G>() {
      public A _1() {
        return P7.this._1();
      }
   ...
   * @return A product with the given function applied.
   */
  public <X> P7<A, B, C, D, X, Z, G> map5(final F<E, X> f) {
    return new P7<A, B, C, D, X, Z, G>() {
      public A _1() {
        return P7.this._1();
      }
   ...
   * @return A product with the given function applied.
   */
  public <X> P7<A, B, C, D, E, X, G> map6(final F<Z, X> f) {
   ...
   * @return A product with the given function applied.
   */
  public <X> P7<A, B, C, D, E, Z, X> map7(final F<G, X> f) {
    return new P7<A, B, C, D, E, Z, X>() {
      public A _1() {
        return P7.this._1();
      }
